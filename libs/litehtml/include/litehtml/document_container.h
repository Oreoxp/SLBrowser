...
namespace litehtml
{
    ...
    virtual void load_image(const std::string& src, const std::string& baseurl, bool redraw_on_ready) = 0;
		virtual void				get_image_size(const std::string& src, const std::string& baseurl, litehtml::size& sz) = 0;
